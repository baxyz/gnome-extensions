 ...
 * verified absent, not just unresearched. They fall back to a generic
 * browser icon at the call site (see menu.helper.ts) instead of guessing.
 * If you add GNOME/adwaita as an exclude and confirm a real match for one of
